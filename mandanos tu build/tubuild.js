...
(function(){
  ...
  if(checkbox && acceptBtn){
    ...
    // Redirigir al carrito al aceptar
    acceptBtn.addEventListener('click', ()=>{
      if(checkbox.checked){
        // Guardar en localStorage que aceptó los términos
        localStorage.setItem('assembly_service_accepted', 'true');
        localStorage.setItem('assembly_service_date', new Date().toISOString());
        
        // Redirigir al carrito
        window.location.href = '../carrito-armado/carritoArmado.html';
      }
    });
  }
})();
